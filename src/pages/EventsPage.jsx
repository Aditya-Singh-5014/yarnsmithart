  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start py-12 lg:py-16 ${index !== 0 ? 'border-t border-tan/50' : ''}`}>
      ...
      <div className={`relative overflow-hidden rounded-sm ${isImageLeft ? 'lg:order-1' : 'lg:order-2'}`}>
        <span className={`absolute top-4 left-4 z-10 ${badgeColor} text-white text-[10px] font-medium tracking-[0.15em] uppercase px-4 py-2 rounded-sm`}>
          {event.badge}
        </span>
        <img
          src={tradeShowImg}
    ...
    <>
      ...
      <section className="relative bg-charcoal py-28 lg:py-36 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="section-label text-copper-light mb-4 tracking-[0.3em]">GLOBAL PRESENCE</p>
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-normal leading-tight italic">
            Events & Fair
          </h1>
        </div>
      </section>
