      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 min-h-[500px]">
          ...
          <div className="relative overflow-hidden">
            <img
              src="https://yarnsmitharts-brand-blueprint.lovable.app/assets/lifestyle-dining-ON8M0PdY.jpg"
          ...
          <div className="bg-charcoal flex items-center px-10 lg:px-16 py-16 lg:py-24">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl lg:text-[2.75rem] text-white leading-[1.15] mb-6">
